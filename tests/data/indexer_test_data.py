...
tests = [
    {
        ...
        "rank_settings": {"titles": ["One Punch Man", "One-Punch Man"], "anilist_id": 21087, "pref_groups": ["HorribleSubs", "Erai-raws"],
    ...
    },
    {
        ...
        "rank_settings": {"titles": ["Wonder Egg Priority"], "anilist_id": 124845, "pref_groups": ["HorribleSubs", "Erai-raws"],
                          "pref_quality": "1080p", "season": 1, "min_gib": 1, "min_seeders": 5, "seeders_importance": 1}
    },
    {
        "name": "Mononoke",
        ...
        "data": {
            ...
            IndexerResult("[reddeimon] Mononoke 2007 [1080p Bluray Rip x264 FLAC]", "", 8, "12.8 GiB"): None,  # TODO: see if fixable
        ...
        "rank_settings": {"titles": ["Mononoke"], "anilist_id": 2246, "pref_groups": ["HorribleSubs", "Erai-raws"],
                          "pref_quality": "1080p", "season": 1, "min_gib": 1, "min_seeders": 5, "seeders_importance": 0}
    },
    {
        "name": "Kaguya-sama",
        ...
        "rank_settings": {"titles": ["Kaguya-sama wa Kokurasetai: Tensai-tachi no Renai Zunousen", "Kaguya-sama: Love is War"], "anilist_id":101921, "pref_groups": ["HorribleSubs", "Erai-raws"],
                          "pref_quality": "1080p", "season": 1, "min_gib": 1, "min_seeders": 5, "seeders_importance": 1}
    },
{
    "enable": True,
    "name": "Demon Slayer",
    "data": {
        IndexerResult("Demon Slayer: Kimetsu no Yaiba The Movie - Mugen Train (Camrip - 720p)[English+Chinese]", "", 206, "1.1 GiB"): None,
        IndexerResult("[Hakata Ramen] Kimetsu no Yaiba (Demon Slayer) S1 (Complete) [1080p HEVC Subs-4x] HR-SS", "", 156, "7.2 GiB"): 1,
        IndexerResult("[CBM] Demon Slayer: Kimetsu no Yaiba 1-26 Complete (Dual Audio) [BDRip 1080p x265 10bit]", "", 87, "18.2 GiB"): 0,
        IndexerResult("[Suki Desu] Kimetsu no Yaiba (Demon Slayer) (Season 1) [BD 1080p][HEVC x265 10bit][Multi-Subs][Judas]", "", 27, "9.4 GiB"): 2,
        IndexerResult("[LostYears] Demon Slayer: Kimetsu no Yaiba - S01 (BD 1080p Hi10P AAC) [Dual Audio]", "", 24, "36.8 GiB"): 2
    },
    "rank_settings": {"titles": ["Kimetsu no Yaiba", "Demon Slayer: Kimetsu no Yaiba"], "anilist_id": 101922, "pref_groups": ["HorribleSubs", "Erai-raws"],
                      "pref_quality": "1080p", "season": 1, "min_gib": 1, "min_seeders": 5, "seeders_importance": 1}
},
]
