...
data = [
    {
        IndexerResult("[Judas] One Punch Man (Seasons 1-2 + OVAs + Specials) [BD 1080p][HEVC x265 10bit][Dual-Audio][Multi-Subs] (Batch)", "", 10, "10 GiB"): 0,
        ...
        IndexerResult("[0x539] One Punch Man S01 (Season 1 + OVAs + OAD) (Dual Audio BD 1080p x264 10bit FLAC)", "", 1, "10 GiB"): 3,
